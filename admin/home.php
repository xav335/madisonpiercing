...
<html class="no-js" lang="en">
	...
	<body>	
		...
		<div class="row">
			<div class="col-md-8">
				<h3>Statistiques</h3>
				<iframe id="laframe" src="https://www.madisonpiercing.fr/awstats/awstats.pl?config=www.madisonpiercing.fr&framename=mainright" style="width:720px;height:500px;" frameborder="1" ></iframe>
			</div>
			<div class="col-md-4">
